const STORY = {
    prologue: [
        { bg: 'meeting', cL: 'none', cR: 'none', spk: 'Narrator', txt: "AIESEC in UTAR office. Evening. Loong Jie stands alone in the meeting room, looking at a whiteboard that reads 'iMYV Department — 26.27.'" },
        ...
        { cL: 'lj_sweat', spk: 'Loong Jie', txt: "...I have no idea what I'm doing." },
    ...
    rounds: {
        1: {
            ...
            scenes: [
                ...
                { spk: 'Narrator', txt: "Polite smiles. Awkward silence." },
                ...
                { cR: 'none', cL: 'lj_sweat', spk: 'Loong Jie', txt: "(I feel the pull in two directions — the team wants connection, but also clarity. How do I start this?)" },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { cR: 'meiling', spk: 'Mei Ling', txt: "That... actually makes me feel better. I thought I was the only one who was nervous." },
                        ...
                        { cL: 'lj', cR: 'none', spk: 'Narrator', txt: "The meeting runs long, but everyone leaves feeling connected. Team Trust established. Members feel psychologically safe." }
                    ]
                },
                {
        ...
        2: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "Two weeks into the term. Loong Jie is reviewing the team's Telegram group. He scrolls through the chat history." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "Loong Jie learns the silence wasn't apathy — it was uncertainty. He needs to CREATE the space for communication." }
                    ]
                },
                {
                    ...
                    con: [
                        ...
                        { spk: 'Narrator', txt: "The group is slightly more active for a few days, then goes quiet again. The root cause remains." }
                    ]
                },
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "Tasks get done, but resentment builds silently. Compliance without commitment." }
                    ]
                }
            ],
        ...
        3: {
            ...
            scenes: [
                { bg: 'meeting', cL: 'arjun', cR: 'none', spk: 'Narrator', txt: "Arjun sends a long, excited message in the group chat, pitching a completely new outreach concept." },
                ...
                { spk: 'Wei Jie', txt: "I'm not your 'bro,' and I'm just being realistic." },
                { cL: 'none', cR: 'none', spk: 'Narrator', txt: "Tension rises. Mei Ling and Siti go silent." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Narrator', txt: "Both feel heard. The team learns that ideas are welcome AND that the leader can guide discussions constructively." }
                    ]
                },
                {
                    ...
                    con: [
                        ...
                        { spk: 'Arjun', txt: "(Maybe next time I just won't bother suggesting anything...)" }
                    ]
                },
                {
                    ...
                    con: [
                        { bg: 'meeting', cL: 'none', cR: 'arjun', spk: 'Arjun', txt: "(Why did I even join this? He asked for ideas in the first meeting, and now he shuts them down.)" },
                        { cR: 'none', spk: 'Narrator', txt: "Arjun starts doing the bare minimum. No more creative input. Innovation dies." }
                    ]
                }
            ],
        ...
        4: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "Week 4. Mei Ling has stopped responding entirely. Her agenda planning document is missing. She missed the last virtual meeting without explanation." },
                ...
                { cL: 'lj_sweat', spk: 'Loong Jie', txt: "(...Wait, did I ever create a space where she COULD tell me? Have I ever checked in with her one-on-one?)" }
            ],
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Mei Ling', txt: "(crying) Thank you for not being mad. I thought you'd think I was useless." },
                        ...
                        { cR: 'meiling', spk: 'Narrator', txt: "Together, they break the document into smaller tasks. Loong Jie pairs her with Siti for support. A turning point for Mei Ling." }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    con: [
                        ...
                        { spk: 'Mei Ling', txt: "(He doesn't care about me. He only cares about the document. Maybe I should just leave...)" },
        ...
        5: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj_sweat', cR: 'thea', spk: 'Thea', txt: "Loong Jie. You look terrible." },
                ...
                { spk: 'Thea', txt: "Let me ask you something. Are you leading your team, or are you doing your team's work FOR them?" },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "Loong Jie is tired after the coaching sessions but feels lighter — the team is growing." }
                    ]
                },
                {
                    pts: 1, txt: "Agree with Thea and start delegating more, but secretly re-edit documents before they go out.",
                    con: [
                        { bg: 'cafeteria', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "The team sees polished work go out. They don't know Loong Jie rewrote it. They don't learn. His burnout continues, just slightly slower." }
                    ]
                },
                {
                    pts: -1, txt: "\"If I don't do it myself, it won't be good enough. The project's reputation is at stake. I'll rest after it's done.\"",
                    con: [
                        { bg: 'cafeteria', cL: 'lj_sweat', cR: 'none', spk: 'Narrator', txt: "Loong Jie continues the solo grind. He becomes irritable and short. The team feels useless and disconnected. Thea watches with concern." }
                    ]
                }
            ],
        ...
        6: {
            ...
            scenes: [
                { bg: 'meeting', cL: 'arjun', cR: 'weijie', spk: 'Narrator', txt: "During a virtual meeting, Arjun and Wei Jie get into a heated argument about the project budget." },
                ...
                { spk: 'Arjun', txt: "Unnecessary?! You think building relationships with schools is UNNECESSARY?" },
                { spk: 'Wei Jie', txt: "I didn't say partnerships are unnecessary. I said YOUR spending plan has waste. Learn to listen." },
                { spk: 'Arjun', txt: "Oh, I'M the one who needs to listen? You shut down every single idea I have!" },
                ...
                { cL: 'none', cR: 'none', spk: 'Narrator', txt: "Silence. Everyone looks at Loong Jie." }
            ],
            choices: [
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "In private follow-ups, both express appreciation. A turning point in team trust." }
                    ]
                },
                {
                    pts: 1, txt: "Step in and make the final budget decision yourself to end the argument quickly.",
                    con: [
                        { bg: 'meeting', cL: 'none', cR: 'none', spk: 'Narrator', txt: "The argument stops, but neither side is satisfied. The underlying tension remains. The team sees Loong Jie as a decision-maker, not a facilitator." }
                    ]
                },
                {
                    pts: -1, txt: "Get frustrated: \"Can you both stop? This is embarrassing. I'll handle the budget myself.\"",
                    con: [
                        { bg: 'meeting', cL: 'none', cR: 'none', spk: 'Narrator', txt: "Both feel dismissed and embarrassed. Trust plummets. The team meeting ends awkwardly." }
                    ]
                }
            ],
        ...
        7: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj', cR: 'siti', spk: 'Loong Jie', txt: "Hey Siti, the school partnership proposal was due yesterday. What happened?" },
                { spk: 'Siti', txt: "Oh my god, Loong Jie, I'm SO sorry. I completely lost track of time." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Siti', txt: "Loong Jie... no one's ever actually HELPED me with this before. They just get frustrated. Thank you." },
                ...
                },
                {
                    ...
                    con: [
                        { bg: 'cafeteria', cL: 'none', cR: 'none', spk: 'Narrator', txt: "Siti submits a rushed proposal that evening. It's passable but not great. No time management skills gained. The pattern will repeat." }
                    ]
                },
                {
                    pts: -1, txt: "\"Siti, this is a critical deliverable. We can't miss deadlines. Please submit it in the next 3 hours.\"",
                    con: [
                        { bg: 'cafeteria', cL: 'none', cR: 'none', spk: 'Narrator', txt: "Siti panics and submits a low-quality proposal in 2 hours. She feels stressed and that Loong Jie doesn't care about her as a person." }
                    ]
                }
            ],
        ...
        8: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj_sweat', cR: 'thea', spk: 'Narrator', txt: "Week 8. Everything is going wrong. Project launch is in 4 weeks. Only 8 volunteers signed up out of 40." },
                ...
                { cL: 'lj', spk: 'Thea', txt: "You've been managing tasks, Loong Jie. But have you been leading people?" }
            ],
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Narrator', txt: "They establish team norms: Weekly check-ins. Disagree respectfully, then commit. Ask for help early. Celebrate small wins. Something shifts." }
                    ]
                },
                {
                    pts: 1, txt: "Call a meeting to regroup on the project plan with clearer roles and deadlines. Briefly mention communication.",
                    con: [
                        { bg: 'meeting', cL: 'none', cR: 'none', spk: 'Narrator', txt: "The meeting provides some task clarity, but the emotional undercurrents remain unaddressed. Organized but not connected." }
                    ]
                },
                {
                    pts: -1, txt: "Send a long message: \"This is crunch time. Here's everything that's behind schedule. Step up.\"",
                    con: [
                        { bg: 'cafeteria', cL: 'none', cR: 'none', spk: 'Narrator', txt: "The message makes the team feel even more pressured and disconnected. Mei Ling considers quitting. Morale at rock bottom." }
                    ]
                }
            ],
        ...
        9: {
            ...
            scenes: [
                { bg: 'cafeteria', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "Week 9. Loong Jie receives a private message from Mei Ling." },
                ...
                { cR: 'none', spk: 'Narrator', txt: "Loong Jie reads the message three times. His heart sinks." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Mei Ling', txt: "(crying) No one's ever told me I had strengths before. Not like that. Not with specific examples." },
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "This becomes the moment Mei Ling starts to transform. She decides to stay because she feels SEEN." }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "Mei Ling leaves the team. Morale drops further." }
                    ]
                }
            ],
        ...
        10: {
            ...
            scenes: [
                { bg: 'meeting', cL: 'lj_sweat', cR: 'none', spk: 'Narrator', txt: "Week 10. The project launch is in 2 weeks. Volunteer count: 18 out of 40." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { cR: 'none', spk: 'Narrator', txt: "The plan is submitted on time. It's excellent. The school partner is impressed." }
                    ]
                },
                {
        ...
        11: {
            ...
            scenes: [
                { bg: 'meeting', cL: 'arjun', cR: 'weijie', spk: 'Narrator', txt: "One week before launch. Volunteer count: 24. Target: 40. They need 16 more in 7 days." },
                ...
                { cR: 'none', spk: 'Narrator', txt: "Everyone is surprised. This is brilliant." }
            ],
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Narrator', txt: "The session gets 200+ views. 12 new volunteers sign up in 3 days. Combined with team outreach, they hit 42 by day 7 — EXCEEDING the target." },
        ...
        12: {
            ...
            scenes: [
                { bg: 'venue', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "The night before the iMYV project officially launches. Everything is set — logistics, venue, facilitator guides, volunteer kits." },
                ...
                { cR: 'siti', spk: 'Siti', txt: "I'm going to cry. I can already tell." },
            ...
            choices: [
                {
                    ...
                    con: [
                        ...
                        { spk: 'Loong Jie', txt: "I think about Mei Ling. She left because I didn't fight for her. That's a regret I'll carry — and a lesson I'll never forget.", showIf: 'meilingLeft' },
                        ...
                        { spk: 'Loong Jie', txt: "Tomorrow isn't just about 40 volunteers. It's about US. We built this together. I'm proud of this team." },
                        { cR: 'arjun', spk: 'Arjun', txt: "(voice cracking) Bro, I'm not crying. My eyes are just... sweating." },
                        ...
                        { cR: 'meiling_sad', spk: 'Mei Ling', txt: "(crying) Thank you... for not giving up on me when I wanted to give up on myself.", skipIf: 'meilingLeft' }
                    ]
                },
                {
    ...
    endings: {
        happy: {
            ...
            scenes: [
                { bg: 'venue', cL: 'lj', cR: 'arjun', spk: 'Narrator', txt: "Project Day. The venue is buzzing. 42 volunteers have arrived. The registration desk is overflowing. The school partner is smiling." },
                ...
                { cR: 'none', spk: 'Loong Jie', txt: "(Leadership isn't about you. It's about the people you serve. It's about coaching them through doubt, facilitating them through conflict, and believing in them when they don't believe in themselves.)" },
        ...
        neutral: {
            ...
            scenes: [
                { bg: 'venue', cL: 'lj', cR: 'none', spk: 'Narrator', txt: "Project Day. 28 volunteers show up. The project runs, but there are hiccups. The sponsor is lukewarm." },
                ...
                { spk: 'Narrator', txt: "😐 NEUTRAL ENDING — ROOM TO GROW" }
            ]
        },
        bad: {
            ...
            scenes: [
                { bg: 'venue', cL: 'lj_sweat', cR: 'none', spk: 'Narrator', txt: "Only 15 volunteers show up. Mei Ling quit weeks ago. Arjun does the bare minimum. The venue decorations are half-used." },
                ...
                { cR: 'thea', spk: 'Thea', txt: "You didn't fail because the project underperformed. You failed because you forgot AIESEC isn't about projects — it's about people." },
                { cR: 'none', spk: 'Narrator', txt: "💔 BAD ENDING — A PAINFUL LESSON LEARNED" }
            ]
        }
    }
};
